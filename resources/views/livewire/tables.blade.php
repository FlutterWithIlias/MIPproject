                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">temp/hum</h6>
                            </div>
                        </div>
    ...
    <td>
        <div class="d-flex px-2 py-1">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-sm">{{ $row->temperature }}</h6>
                <p class="text-xs text-secondary mb-0">°C</p>
            </div>
        </div>
    </td>
    <td>
        <p class="text-xs font-weight-bold mb-0">{{ $row->Humidite }}</p>
        <p class="text-xs text-secondary mb-0">%HR</p>
    </td>
    <td class="align-middle text-center text-sm">
        <span class="badge badge-sm bg-gradient-success">{{ $row->Cordonnees }}</span>
    </td>
